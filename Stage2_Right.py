...
#Defining visual stimuli

gameDisplay=pygame.display.set_mode((800, 480))#,pygame.FULLSCREEN
changex=4 #4 px per refresh is going to make for a 1 Hz TF. Adjust if needed...
...
print "Making noise video right now" 
...
while making_noise_frames <=39:
    ...
    print "Converting next frame into image"
